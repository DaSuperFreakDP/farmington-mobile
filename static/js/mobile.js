...
document.addEventListener('DOMContentLoaded', function() {
    ...
    inputs.forEach(function(input) {
        ...
        // Special handling for league form inputs
        if (input.name === 'league_name' || input.name === 'league_code') {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Handle league form inputs specifically
        const leagueInputs = document.querySelectorAll('input[name="league_name"], input[name="league_code"]');
